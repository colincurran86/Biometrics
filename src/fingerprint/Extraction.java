...
public class Extraction {
     ...
     * @see
     * http://manthapavankumar.wordpress.com/2012/12/16/converting-a-color-image-to-a-grayscale-image-programatically-using-java/
     */
    ...
    public static int[][] getCN(int skeleton[][])//after thinning
    {
        ...
        System.out.println("MINUTIAE POINTS");
                ...
                = genGraph(
                        getCN(
                                getFastParallelAlgoSkeleton(
                                        binarizing(
                                                ImageIO.read(new File("C:/Users/colin/Desktop/fingerprint.jpg"))))));  
        // ImageIO.read(input);

        System.out.println("Comparing Sample#"
                + compare(graph1,
                        genGraph(
                                getCN(
                                        getFastParallelAlgoSkeleton(

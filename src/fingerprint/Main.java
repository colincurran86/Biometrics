...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //skeletonze image
      //  ZhangSuenThinning thinned = new ZhangSuenThinning();
      //  thinned.applyInPlace(fb);
        
        /*isplay skeleton image
       ...
       //extract ridges
        //extractRidgeEndings(fb.toBufferedImage());
    ...
    private static BufferedImage binarize(BufferedImage original) {
        ...
        for (int row = 0; row < original.getWidth(); row++) {
            for (int col = 0; col < original.getHeight(); col++) {
                ...
                System.out.println("PIXEL VALUE: " + newPixel);
            }
        }
